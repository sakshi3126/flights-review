...
const ReviewForm = (props) => {
    const ratingOptions = [5, 4, 3, 2, 1].map((score, index) => {
        return (
            <Fragment>
                <input type="radio" value={score} name="rating" checked={props.review.score == score} onChange={() => console.log('selected', score)}
                       id={`rating -${score}`}/>
    ...
    return (
        <ReviewWrapper>
            <form onSubmit={props.handleSubmit}>
                ...
                <Field>
                    <input onChange={props.handleChange} type="text" name="title" value={props.review.title}
